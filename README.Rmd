...
```
While *sunflower* can work by simply relying on R native pipes (`|>`), it is recommended to install the [*tidyverse* package](https://www.tidyverse.org/) as it allow to use *tidyverse* pipes (`%>%`) and functions from packages like *dplyr*, *readr*, and *ggplot2* to support the work.
