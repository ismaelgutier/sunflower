...
and the [word2vec CRAN package](https://cran.r-project.org/web/packages/word2vec/readme/README.html) for further computations depending word2vec models required to classify errors (last section in this markdown).
