...
Compute the similarity metrics using the `get_formal_indexes()` function.

```{r, formal metrics}

IGC_step2 = IGC_step1 %>% get_formal_indexes(item_col = "item",
...
IGC_step2_clean = IGC %>%
                        ...
                        get_formal_indexes(item_col = "item",
                          response_col = "Response",
                          attempt_col = "Attempt",
                          group_cols = c("ID", "task_item_ID"))
...
IGC_step4 <- IGC_step3 %>% classify_errors(access_col = "accessed", RA_col = "RA", 
                                          response_col = "Response", classify_RAs = T)
